...
/*
	Theme Name: actforclimate
	Theme URI: 
	Description: actforclimate multipurpose Drupal theme
	Version: 1.0
	Author: Worthapost
...
// load css files
drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/css/bootstrap.css',  array(  'group' => 'CSS_THEME', 'weight' => 93));
drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/style.css',  array(  'group' => 'CSS_THEME', 'weight' => 96));
drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/customize_actforclimate.css',  array(  'group' => 'CSS_THEME', 'weight' => 97));


// Misc
drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/js/bootstrap.js', array('type' => 'file', 'scope' => 'footer', 'group' => 'JS_LIBRARY', 'weight' => 20));
drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/js/selectnav.min.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 40));

// colorbox
drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/js/jquery.colorbox-min.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 42));
drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/css/colorbox.css',  array(  'group' => 'CSS_THEME', 'weight' => 98));


// superfish
drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/js/hoverIntent.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 25));
drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/js/superfish.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 30));
drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/css/superfish.css',  array(  'group' => 'CSS_THEME', 'weight' => 93));
    ...
    function get_google_css_string(){
       if(theme_get_setting('google_enable') == 1) {
          ...
          $google_quote_font = str_replace(' ', '+' , $google_quote_font);
           ...
           $google_heading_font =   $google_heading_font . ':300,300italic,400,400italic,700,700italic,900,900italic&amp;subset=latin,greek-ext,cyrillic,latin-ext,greek,cyrillic-ext,vietnamese';   
           $google_menu_font = $google_menu_font . ':300,300italic,400,400italic,700,700italic,900,900italic&amp;subset=latin,greek-ext,cyrillic,latin-ext,greek,cyrillic-ext,vietnamese';
           $google_site_font =    $google_site_font . ':300,300italic,400,400italic,700,700italic,900,900italic&amp;subset=latin,greek-ext,cyrillic,latin-ext,greek,cyrillic-ext,vietnamese';
           $google_slider_font =    $google_slider_font . ':300,300italic,400,400italic,700,700italic,900,900italic&amp;subset=latin,greek-ext,cyrillic,latin-ext,greek,cyrillic-ext,vietnamese';
...
function get_googlefont_style_code(){
	...
	body.actforclimate, #wap-menu ul.sf-menu li span.tip a, .ei-title h3, #main_slider .slider-body, #main_slider .slider-link, .btn{
...
// user box
function actforclimate_welcome_user(){
	global $user;
...
// menus customization
function actforclimate_menu_tree__main_menu($variables) {
...
// Custom breadcrumb
function actforclimate_breadcrumb($breadcrumb) {
...
// Preprocess Page
function actforclimate_preprocess_page(&$variables) {
...
// Customized tabs
function actforclimate_menu_local_tasks(&$variables) {
  $output = '';
...
function actforclimate_menu_local_task($variables) {
...
function actforclimate_preprocess_node(&$variables) {
...
function actforclimate_preprocess_field(&$variables) {
...
function actforclimate_preprocess_comment(&$variables) {
...
function actforclimate_preprocess_table(&$variables){
	$variables['attributes']['class'] = array(' table table-striped ');
}

function actforclimate_preprocess_button(&$variables) {
  $variables['element']['#attributes']['class'][] = ' btn ';
}

function actforclimate_preprocess_simplenews_block(&$vars){
...
//status messages
function actforclimate_status_messages($variables) {
...
if(theme_get_setting('slider_type') == 'nivo'){
	drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/sliders/nivo/themes/bar/bar.css', 'theme');
	drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/sliders/nivo/nivo-slider.css', 'theme');
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/nivo/jquery.nivo.slider.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 27));
	drupal_add_js('
	(function ($) {
...
if(theme_get_setting('slider_type') == 'flex'){
	// load css and js
	drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/sliders/flex/flexslider.css', 'theme');
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/flex/jquery.flexslider-min.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 6));
	drupal_add_js('
	(function ($) {
...
if(theme_get_setting('slider_type') == 'iview'){
	// load css and js
	drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/sliders/iview/css/iview.css', 'theme');
	drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/sliders/iview/css/skin4/style.css', 'theme');
		
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/iview/js/raphael-min.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 6));
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/iview/js/jquery.easing.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 7));
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/iview/js/iview.min.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 8));
			...
			$thumb_output = '';
				for ($i=1; $i < 10; $i++) {
					...
					if($img_for_thumb != ''){
						...
						$thumb_output .= '<img src="'. drupal_get_path('theme', 'actforclimate') .'/timthumb.php?src='. $img_for_thumb .'&h=90&w=120" />';
...
if(theme_get_setting('slider_type') == 'elastic'){
	// load css and js
	drupal_add_css(drupal_get_path('theme', 'actforclimate') .'/sliders/elastic/css/style.css', 'theme');
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/elastic/js/jquery.eislideshow.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 6));
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/elastic/js/jquery.easing.1.3.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_LIBRARY', 'weight' => 7));	
	drupal_add_js("
	(function ($) {
    	$(function() {
...
<div id="ei-slider" class="ei-slider">
	<ul class="ei-slider-large">
		<li><img src="http://localhost/actforclimate/themeforest_package/sites/all/themes/actforclimate/img/slides/slide1.jpg" alt="" />
			<div class="ei-title">
		...
		<li><img src="http://localhost/actforclimate/themeforest_package/sites/all/themes/actforclimate/img/slides/slide2.jpg" alt="" />
			<div class="ei-title">
		...
		<li><img src="http://localhost/actforclimate/themeforest_package/sites/all/themes/actforclimate/img/slides/slide3.jpg" alt="" />
			<div class="ei-title">
...
function icomp_prepare_piecemaker(){
	...
	// every timy when theme settings form is submitted, piecemaker_slider_helper() from actforclimate_module.module function writes 'empty' keyword in it
	if($fstring == 'empty'){
		$output = '';
...
if(theme_get_setting('slider_type')  == 'piecemaker'){
	drupal_add_js(drupal_get_path('theme', 'actforclimate') . '/sliders/piecemaker/scripts/swfobject/swfobject.js', array('type' => 'file', 'scope' => 'header', 'group' => 'JS_DEFAULT', 'weight' => 25));
}
...
<Piecemaker>
	<Contents>
		<Image Source="http://localhost/actforclimate/upgrade/sites/default/files/styles/slider/public/0008020422O-1920x1280.jpg" Title="Unlimited Colors and Easy to customize">
			<Text>
		...
		<Image Source="http://localhost/actforclimate/upgrade/sites/default/files/styles/slider/public/triworks_arch2.jpg" Title="Lorem ipsum dolor sit amet">
			<Text>
				<p class="piecemaker-caption-body">
