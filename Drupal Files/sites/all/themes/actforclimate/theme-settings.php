...
include_once( drupal_get_path('theme', 'actforclimate') . '/includes/google-fonts.php');
...
function actforclimate_form_system_theme_settings_alter(&$form, &$form_state) {
	...
	$form['theme_settings_tab']['misc_settings']['actforclimate_breadcrumb'] = array(
		'#type' => 'checkbox',
		'#title' => t('actforclimate\'s style breadcrumb'),
		'#description' => t('Use actforclimate\'s style breadcrumb instead of Drupal default breadcrumb. '),
		'#default_value' => theme_get_setting('actforclimate_breadcrumb'),
	);
	...
	include_once( drupal_get_path('theme', 'actforclimate') . '/includes/slider_options.php');
