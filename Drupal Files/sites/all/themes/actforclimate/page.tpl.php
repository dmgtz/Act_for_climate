			...
			<div id="top-bar-inner">
				...
				<div class="span3 loginlinks">
					<?php if(theme_get_setting('use_login_links') == 1) { ?>
						<div id="user_links">			
							<?php if (!($user->uid)) { print user_login_links(); } else { print  actforclimate_welcome_user(); } ?>	
						</div>
					<?php } ?>
				</div>
	...
	<div id="zone1" class="row-fluid">
		...
		<?php if(($title) && !(upperRegionsExist($upper_blocks1, $upper_blocks2, $upper_blocks3, $upper_blocks4))){ ?>
			<div id="title-region" class="row-fluid">	
				...
				<?php if(!empty($breadcrumb)){  if(theme_get_setting('actforclimate_breadcrumb') == '1') print '<div class="breadcrumb">' . "<div id='home-icon'> <a href='$base_path'>" . ' <span class="icon-home"></span></a> </div> ' . $breadcrumb . ' &raquo; ' . breadcrumb_title($title) . '</div>'; elseif(!empty($breadcrumb)) print '<div class="breadcrumb">' . $breadcrumb . '</div>';  ?><?php } ?>						
				</div>
			</div>
		<?php } ?>
			...
			<div id="content-area" class="<?php print $content_span; ?>">
				<div class="inner <?php if(!$left_sidebar) print ' inner-no-left-sidebar '; if(!$right_sidebar) print ' inner-no-right-sidebar '; if(!$right_sidebar && !$left_sidebar) print ' inner-no-sidebar '; ?>">
					...
					<div id="content-region">
				        ...
				        <?php if(($title) && (upperRegionsExist($upper_blocks1, $upper_blocks2, $upper_blocks3, $upper_blocks4))){ ?>
				            <?php if(!empty($breadcrumb)){  if(theme_get_setting('actforclimate_breadcrumb') == '1') print '<div class="breadcrumb">' . $you_here . $breadcrumb . ' &raquo; ' . breadcrumb_title($title) . '</div>'; elseif(!empty($breadcrumb)) print '<div class="breadcrumb">' . $breadcrumb . '</div>';  ?><?php } ?>     
				        	<?php print render($title_prefix); ?>
								<h1 class="page-title"><?php print $title ?></h1>  
							<?php print render($title_suffix); ?>
				        <?php } ?>	
